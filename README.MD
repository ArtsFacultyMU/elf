...
This repository is based on [Moodle main repository](https://github.com/moodle/moodle), more specifically on branch MOODLE_34_STABLE, and it integrates several third party and custom plugins.
...
## STRUCTURE
There are several remotes that correspond to repositories containing third-party, custom or customized core plugins. Content of these repositories (from specified branch) corresponds to content of specific folder, list of remotes with their path, repository and branch is listed in following tables:

### MOODLE CORE
Remote | Repository | Branch | Path
------ | ---------- | ------ | ----
moodle |  [Link](https://github.com/moodle/moodle) | MOODLE_34_STABLE | root directory (/)

### THIRD-PARTY PLUGINS
Remote | Repository | Branch | Path
------ | ---------- | ------ | ----
mod-hotpot | [Link](https://github.com/gbateson/moodle-mod_hotpot.git) | master | mod/hotpot
mod-questionnaire | [Link](https://github.com/remotelearner/moodle-mod_questionnaire.git) | MOODLE_34_STABLE | mod/questionnaire
mod-tab | [Link](https://github.com/oohoo/moodle-mod_tab.git) | MOODLE_30_STABLE (newer than master...) | mod/tab
mod-attendance | [Link](https://github.com/danmarsden/moodle-mod_attendance.git) | MOODLE_34_STABLE | mod/attendance
...
Remote | Repository | Branch | Path
------ | ---------- | ------ | ----
mod-chat | [Link](https://github.com/ArtsFacultyMU/elf-mod-chat.git) | MOODLE_34_STABLE | mod/chat
mod-folder | [Link](https://github.com/ArtsFacultyMU/elf-mod-folder.git) | MOODLE_34_STABLE | mod/folder
mod-data | [Link](https://github.com/ArtsFacultyMU/elf-mod-data.git) | MOODLE_34_STABLE | mod/data
mod-assign-feedback-editpdf | [Link](https://github.com/ArtsFacultyMU/elf-mod-assign-feedback-editpdf.git) | MOODLE_34_STABLE | mod/assign/feedback/edifpdf
question-type-multianswer | [Link](https://github.com/ArtsFacultyMU/elf-question-type-multianswer.git) | MOODLE_34_STABLE | question/type/multianswer

### CUSTOM PLUGINS
Remote | Repository | Branch | Path
------ | ---------- | ------ | ----
theme-elf_bs | [Link](https://github.com/ArtsFacultyMU/elf-theme-elf_bs.git) | MOODLE_34_STABLE | theme/elf_bs
