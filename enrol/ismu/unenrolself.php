...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'ismu'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/ismu/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_ismu', format_string($course->fullname));
