...
/**
 * Extends core navigation to display the remote backup link in the frontpage administration.
 *
 * @param navigation_node $navigation The navigation node to extend
 * @param stdClass        $course The course object
 * @param context         $context The course context
 */
function local_remote_backup_provider_extend_navigation_frontpage($navigation, $course, $context) {
    if (has_capability('local/remote_backup_provider:access', $context)) {
        $url = new moodle_url('/local/remote_backup_provider/index.php');
