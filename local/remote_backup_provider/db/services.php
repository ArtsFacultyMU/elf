...
$functions = array(
    ...
    'local_remote_backup_provider_process_subplugin_post' => array(
        'classname' => 'local_remote_backup_provider\external\process_subplugin_post',
        'methodname' => 'process_subplugin_post',
        'description' => 'The adapter for the post type subplugins.',
        'type' => 'write',
    ),
);
...
$services = array(
    'local_remote_backup_provider' => array(
        'functions' => array(
            ...
            'local_remote_backup_provider_process_subplugin_post',
        ), 
        'restrictedusers' => 0, 
        'enabled' => 1, 
