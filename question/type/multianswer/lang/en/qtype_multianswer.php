...
$string['textboxsize_help'] = 'If you are using the <i>Fixed size</i> textbox type for your cloze question, you can specify the size of the text boxes here (the figure refers to the number of visible characters within the text field).'; // ELF -- FF -- FB help
