 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class newassignment_portfolio_caller extends portfolio_module_caller_base {
    ...
    */
    ...
    function __construct($callbackargs) {
        ...
        $this->cm = get_coursemodule_from_id('newassignment', $this->cmid, 0, false, MUST_EXIST);
    }
    ...
    public function load_data() {
        ...
        if (empty($this->fileid)) {
            if (empty($this->sid) || empty($this->area)) {
                throw new portfolio_caller_exception('invalidfileandsubmissionid', 'mod_newassignment');
            }
    ...
    private function get_submission_plugin() {
        ...
        $assignment = new NewAssignment($context, null, null);
        return $assignment->get_submission_plugin();
    }
    ...
    public function check_permissions() {
        $context = context_module::instance($this->cmid);
        return has_capability('mod/newassignment:exportownsubmission', $context);
    }
    ...
    public static function display_name() {
        return get_string('modulename', 'newassignment');
    }
