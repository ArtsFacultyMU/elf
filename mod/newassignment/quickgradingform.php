 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_newassignment_quick_grading_form extends moodleform {
    /**
    ...
    function definition() {
        ...
        // buttons
        $mform->addElement('submit', 'savequickgrades', get_string('saveallquickgradingchanges', 'newassignment'));
    }
}
