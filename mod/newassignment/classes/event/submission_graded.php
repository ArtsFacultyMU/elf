...
class submission_graded extends base {
     ...
     */
    public static function create_from_grade(\NewAssignment $assign, \stdClass $grade) {
        $data = array(
        ...
        $event->add_record_snapshot('newassign_grades', $grade);
        return $event;
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has graded the submission '$this->objectid' for the user with " .
            "id '$this->relateduserid' for the newassignment with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventsubmissiongraded', 'mod_newassignment');
    }
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'newassign_grades';
    }
    ...
    protected function get_legacy_logdata() {
        $grade = $this->get_record_snapshot('newassign_grades', $this->objectid);
