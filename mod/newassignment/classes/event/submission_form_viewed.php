...
class submission_form_viewed extends base {
     ...
     */
    public static function create_from_user(\NewAssignment $assign, \stdClass $user) {
        $data = array(
    ...
    public static function get_name() {
        return get_string('eventsubmissionformviewed', 'mod_newassignment');
    }
    ...
    protected function get_legacy_logdata() {
        if ($this->relateduserid == $this->userid) {
            $title = get_string('editsubmission', 'mod_newassignment');
        } else {
            $user = $this->get_record_snapshot('user', $this->relateduserid);
            $title = get_string('editsubmissionother', 'mod_newassignment', fullname($user));
        }
