...
class submission_viewed extends base {
     ...
     */
    public static function create_from_submission(\NewAssignment $assign, \stdClass $submission) {
        $data = array(
        ...
        $event->add_record_snapshot('newassign_submissions', $submission);
        return $event;
    }
    ...
    public static function get_name() {
        return get_string('eventsubmissionviewed', 'mod_newassignment');
    }
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewsubmissionforuser', 'mod_newassignment', $this->relateduserid);
