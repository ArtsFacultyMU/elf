...
class feedback_viewed extends base {
     ...
     */
    public static function create_from_feedback(\NewAssignment $assign, \stdClass $feedback) {
        $data = array(
            'objectid' => $feedback->id,
            'relateduserid' => $feedback->userid,
        ...
        $event->add_record_snapshot('newassign_feedbacks', $feedback);
        return $event;
    }
    ...
    protected function init() {
        $this->data['objecttable'] = 'newassign_feedbacks';
        $this->data['crud'] = 'r';
    ...
    public static function get_name() {
        return get_string('eventfeedbackviewed', 'mod_newassignment');
    }
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewfeedbackforuser', 'mod_newassignment', $this->relateduserid);
