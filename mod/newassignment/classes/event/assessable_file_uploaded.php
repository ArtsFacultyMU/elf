 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assessable_file_uploaded extends \core\event\assessable_uploaded {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has uploaded a file to the submission with id '$this->objectid' " .
            "in the newassignment activity with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'mod_newassignment');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/newassignment/view.php', array('id' => $this->contextinstanceid));
    }
    ...
    protected function init() {
        parent::init();
        $this->data['objecttable'] = 'newassign_submissions';
    }
