 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_newassignment_submission_form extends moodleform {
    ...
    function definition() {
        ...
        $this->add_action_buttons(true, get_string('submitassignment', 'newassignment'));
        if ($data) {
            $this->set_data($data);
        }
    }
